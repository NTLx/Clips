...
| 知识库 | 定位 | 与 Clips 的关系 |
|-------|------|----------------|
| DingTalkDevDoc | 钉钉开发者文档专项知识库 | 独立，可通过 `../DingTalkDevDoc/` 引用 |
| 企业AI转型顾问知识库 | AI转型课程专项知识库 | 独立，可通过 `../企业AI转型顾问知识库/` 引用 |
| OpenClaw官方文档 | OpenClaw产品专项知识库 | 独立，可通过 `../OpenClaw官方文档/` 引用 |
| **Clips** | 大杂烩文章剪藏 Wiki | 本知识库，LLM Wiki 模式实验场 |
...
```markdown
# 引用 DingTalkDevDoc
[[../DingTalkDevDoc/应用开发/平台简介/xxx]]

# 引用 企业AI转型顾问
[[../企业AI转型顾问知识库/20-概念词典/Agent]]

# 引用 OpenClaw官方文档
[[../OpenClaw官方文档/Agent-Workspace]]
```

### 从其他知识库引用 Clips

```markdown
# 从其他知识库引用 Clips 的 entity
[[../Clips/10-wiki/entities/Knowledge-Work]]

# 从其他知识库引用 Clips 的 topic
[[../Clips/10-wiki/topics/Knowledge-Work-Evolution]]
```
...
- [x] Phase 0: OpenClaw官方文档 移出
- [x] Phase 1: 三层目录结构创建
- [x] Phase 2: Schema 文件编写
- [x] Phase 3: 迁移未整理文章（15 篇全部编译）
- [x] Phase 4: Entity/Topic/Comparison 页面系统完善

### 待开始 ⏳

- [ ] Phase 5: 自动化配置（Web Clipper）
