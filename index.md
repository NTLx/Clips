...
| Entity | 定义 | 来源 |
|--------|------|------|
| [[10-wiki/entities/Taste\|Taste（品味）]] | 在不确定条件下做出独特判断的能力 | Good Taste the Only Real Moat Left |
| [[10-wiki/entities/Judgment\|Judgment（判断力）]] | 识别什么过于通用、什么隐藏真正权衡的能力 | Good Taste the Only Real Moat Left |
| [[10-wiki/entities/Specificity\|Specificity（特异性）]] | 产生深入特定上下文内容的竞争优势 | Good Taste the Only Real Moat Left |
| [[10-wiki/entities/Agent-First-Enterprise\|Agent-First Enterprise]] | AI 系统运营流程，人类设定目标的组织模式 | Enabling agent-first process redesign |
| [[10-wiki/entities/Human-Governor-Agent-Operator\|Human-Governor-Agent-Operator]] | 人类治理、Agent 运营的分工模式 | Enabling agent-first process redesign |
| [[10-wiki/entities/Machine-Readable-Processes\|Machine-Readable Processes]] | Agent 运营的技术基础设施 | Enabling agent-first process redesign |
| [[10-wiki/entities/Conscious-Creators\|Conscious Creators]] | 拒绝干扰、专注内在世界的新 1% | The Conscious 1% |
| [[10-wiki/entities/Inner-World-Mastery\|Inner World Mastery]] | 掌控内心对话、为原创创造空间的能力 | The Conscious 1% |
| [[10-wiki/entities/Decision-Quality\|Decision Quality]] | 基于清晰和信念而非过度分析的决策能力 | The Conscious 1% |
| [[10-wiki/entities/Resonance\|Resonance]] | 创作与自我身份的共鸣 | The Conscious 1% |
| [[10-wiki/entities/Git-Fluent-Agents\|Git-Fluent Agents]] | 深度理解 Git 的 AI 编码 Agent | Using Git with coding agents |
| [[10-wiki/entities/History-Rewriting\|History Rewriting]] | 将 Git 历史视为可编辑叙事的理念 | Using Git with coding agents |
| [[10-wiki/entities/Agentic-Engineering\|Agentic Engineering]] | 利用 AI Agent 转变开发方式的工程范式 | Using Git with coding agents |
| [[10-wiki/entities/Claude-Code-CLI\|Claude Code CLI]] | Claude 命令行工具 | Claude Code 文章 |
| [[10-wiki/entities/Claude-Skills\|Claude Skills]] | Claude 技能系统 | Claude Code 文章 |
| [[10-wiki/entities/PTY-Mode\|PTY Mode]] | 伪终端模式 | Claude Code 文章 |
| [[10-wiki/entities/Headless-Mode\|Headless Mode]] | 无头运行模式 | Claude Code 文章 |
| [[10-wiki/entities/Context-Engineering\|Context Engineering]] | 上下文工程 | Claude Code 文章 |
| [[10-wiki/entities/Multi-Layer-Memory\|Multi-Layer Memory]] | 多层记忆系统 | Claude Code 文章 |
| [[10-wiki/entities/Agent-Swarm\|Agent Swarm]] | Agent 群体协作 | Claude Code 文章 |
| [[10-wiki/entities/Three-State-Protocol\|Three-State Protocol]] | 三态协议 | Claude Code 文章 |
| [[10-wiki/entities/OpenClaw\|OpenClaw]] | OpenClaw 平台 | OpenClaw 文章 |
| [[10-wiki/entities/seekdb\|seekdb]] | seekdb 数据库工具 | OpenClaw 文章 |
| [[10-wiki/entities/Wisdom-Work\|Wisdom Work]] | 智慧工作 | Career-Skills 文章 |
| [[10-wiki/entities/Emotional-Clarity\|Emotional Clarity]] | 情绪清晰 | Career-Skills 文章 |
| [[10-wiki/entities/Discernment\|Discernment]] | 识别能力 | Career-Skills 文章 |
| [[10-wiki/entities/Connection\|Connection]] | 连接能力 | Career-Skills 文章 |
...
| Topic | 描述 | 相关 Entity |
|-------|------|------------|
| [[10-wiki/topics/AI-Era-Taste-and-Judgment\|AI 时代的品味与判断力]] | AI 让合格产出廉价，品味变得更有价值 | Taste, Judgment, Specificity |
| [[10-wiki/topics/Agent-First-Process-Redesign\|Agent-First 流程重构]] | 企业如何围绕 Agent 重新设计运营模式 | Agent-First-Enterprise, Human-Governor-Agent-Operator, Machine-Readable-Processes |
| [[10-wiki/topics/Conscious-Creation-in-AI-Era\|AI 时代的有意识创造]] | 成为新 1% 的路径：内在掌控与三大指标 | Conscious-Creators, Inner-World-Mastery, Decision-Quality, Taste, Resonance |
| [[10-wiki/topics/Git-with-Coding-Agents\|Git 与编码 Agent]] | Agent 如何改变版本控制工作方式 | Git-Fluent-Agents, History-Rewriting, Agentic-Engineering |
| [[10-wiki/topics/Claude-Code-Automation\|Claude Code 自动化]] | Claude Code 的自动化能力与实践 | Claude-Code-CLI, Claude-Skills, PTY-Mode, Headless-Mode |
...
|------------|---------|------------|
| [[10-wiki/comparisons/Agent-First-vs-Traditional-Automation\|Agent-First vs Traditional Automation]] | 运营模式、绩效提升、流程设计 | Agent-First-Enterprise, Human-Governor-Agent-Operator |
| [[10-wiki/comparisons/Cook-vs-Chef\|Cook vs Chef]] | 创作方式、理解深度、AI 时代影响 | Taste, Conscious-Creators |
| [[10-wiki/comparisons/Knowledge-Work-vs-Wisdom-Work\|Knowledge Work vs Wisdom Work]] | 核心能力、价值来源、AI 影响 | Wisdom-Work, Emotional-Clarity, Discernment, Connection |
| [[10-wiki/comparisons/PTY-Mode-vs-Headless-Mode\|PTY Mode vs Headless Mode]] | 交互方式、适用场景、输出处理 | PTY-Mode, Headless-Mode, Claude-Code-CLI |
| [[10-wiki/comparisons/RAG-vs-LLM-Wiki\|RAG vs LLM Wiki]] | 知识处理、累积性、维护成本 | Context-Engineering, Multi-Layer-Memory |
