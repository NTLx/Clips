...
aliases:
  - AI-Native Shipping
  - AI 原生发布
definition: "Cat Wu 描述的 Anthropic 极速迭代模式：通过 Research Preview 降低发布门槛 + Evergreen Launch Room 精简跨职能协作 + Metrics Readout/Team Principles 替代 PRD——将产品功能从 6 个月压缩至 1 天"
created: 2026-05-08
updated: 2026-05-08
tags:
  - AI
...
> [!definition] 定义
> **AI-Native Shipping** 是 Cat Wu 描述的 Anthropic 极速迭代模式——产品功能周期从 6 个月压缩至 1 个月，有时 1 周，甚至 1 天。这不是靠更好的 AI 模型（虽然模型有帮助），而是靠三件事：(1) 目标极度清晰（工程师自行决策）、(2) Research Preview 降低发布心理门槛、(3) Evergreen Launch Room 流水线式跨职能协作。
